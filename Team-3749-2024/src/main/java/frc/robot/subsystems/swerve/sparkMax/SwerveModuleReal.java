...
public class SwerveModuleReal implements SwerveModuleIO {
    ...
    public void updateData(ModuleData data) {
        ...
        data.driveCurrentAmps = Math.abs(driveReal.getOutputCurrent());
        ...
        data.turnCurrentAmps = Math.abs(turnReal.getOutputCurrent());
    ...
    public void setDriveVoltage(double volts) {
        ...
        driveReal.setVoltage(driveAppliedVolts);
    }
    @Override
    public void setTurnVoltage(double volts) {
        turnAppliedVolts = MathUtil.clamp(volts, -8.0, 8.0);
        turnReal.setVoltage(turnAppliedVolts);
    }
}